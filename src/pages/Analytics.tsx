        ...
        <Grid size={{ xs: 12 }}>
          <Card sx={{ minHeight: 400, display: 'flex', alignItems: 'center', justifyContent: 'center', borderStyle: 'dashed', borderWidth: 2 }}>
            <CardContent sx={{ textAlign: 'center' }}>
              ...
              <Typography variant="h6" color="text.secondary">Analytics Dashboard Placeholder</Typography>
              <Typography variant="body2" color="text.secondary">Detailed charts and reports will appear here.</Typography>
            </CardContent>
          </Card>
        </Grid>
      </Grid>
